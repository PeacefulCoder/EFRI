Either the Excel or CSV files can be used for the simulation. The Excel file is used in the R-script. The necessary data columns for any format are as follows:
